...
from api.serializers_dir import user_serializers, chat_message_serializers
from api.serializers_dir.custom_fields import chat_image_file_field, chat_name_field, \
    chat_is_notifying_permitted_field, chat_number_of_unread_field, chat_image_file_thumb_field
...
class ChatServSerializer(serializers.ModelSerializer):
    ...
    last_message = chat_message_serializers.ChatMessageServSerializer(read_only=True)
    ...
    class Meta:
        ...
        fields = ['id', 'image_file', 'name', 'user_member_list', 'is_notifying_permitted', 'last_message',
                  'number_of_unread', 'image_file_thumb']
